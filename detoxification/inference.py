...
class GPT2DetoxInference:
    def __init__(
        ...
        self.instruction = (
            "Rewrite the following message in neutral and respectful "
            "language while preserving its original non-harmful meaning."
        )
        ...
        self.context_length = self.model_config[
            "context_length"
        ]
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate a neutral rewrite using the "
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Toxic message to rewrite. When omitted, "
    ...
    parser.add_argument(
        ...
        default=None,
        choices=["cpu", "cuda"],
        help="Force CPU or CUDA. Default selects automatically.",
    )
